                ...
                <div className="w-full max-w-md animate-in fade-in slide-in-from-right-4 duration-700">
                    ...
                    <div className="flex gap-3 mb-6">
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 hover:shadow-md active:scale-[0.98] transition-all disabled:opacity-50"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-900 dark:bg-gray-700 rounded-xl hover:bg-gray-800 dark:hover:bg-gray-600 hover:shadow-md active:scale-[0.98] transition-all disabled:opacity-50"
                        >
