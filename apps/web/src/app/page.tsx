...
/**
 * 繝帙・繝�逕ｻ髱｢・医Γ繧､繝ｳ繝壹・繧ｸ・・ * 
 * Dexie.js (IndexedDB) 繧剃ｽｿ逕ｨ縺励※繝・・繧ｿ繧呈ｰｸ邯壼喧縺励∪縺吶・ * PC譛驕ｩ蛹厄ｼ・繧ｫ繝ｩ繝�繝ｬ繧､繧｢繧ｦ繝・(30% - 30% - 40%)
 */
...
export default function Home() {
  ...
  // DB縺九ｉ繝・・繧ｿ繧貞叙蠕・  const todos = useLiveQuery(() => db.todos.orderBy("createdAt").reverse().toArray()) || [];
  ...
  // 譌･莉・譎る俣繧ｭ繝ｼ繝玲ｩ溯・逕ｨ縺ｮ迥ｶ諷・  const [keptDate, setKeptDate] = useState<Date | null>(null);
