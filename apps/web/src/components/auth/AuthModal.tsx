                ...
                <div className="p-6">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all disabled:opacity-50"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-900 dark:bg-gray-700 border border-gray-900 dark:border-gray-600 rounded-xl hover:bg-gray-800 dark:hover:bg-gray-600 transition-all disabled:opacity-50"
                        >
